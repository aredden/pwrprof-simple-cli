...
namespace PowerProfLangIndependent {
    ...
    public static class Lookup {
        ...
        {
            { Sub.NO_SUBGROUP,                  new Guid("fea3413e-7e05-4911-9a71-700331f1c294") },
            { Sub.DISK_SUBGROUP,                new Guid("0012ee47-9041-4b5d-9b77-535fba8b1442") },
            { Sub.SYSTEM_BUTTON_SUBGROUP,       new Guid("4f971e89-eebd-4455-a8de-9e59040e7347") },
            { Sub.PROCESSOR_SETTINGS_SUBGROUP,  new Guid("54533251-82be-4824-96c1-47b60b740d00") },
            { Sub.VIDEO_SUBGROUP,               new Guid("7516b95f-f776-4464-8c53-06167f40cc99") },
            { Sub.BATTERY_SUBGROUP,             new Guid("e73a048d-bf27-4f12-9731-8b2076e8891f") },
            { Sub.SLEEP_SUBGROUP,               new Guid("238C9FA8-0AAD-41ED-83F4-97BE242C8F20") },
            { Sub.PCIEXPRESS_SETTINGS_SUBGROUP, new Guid("501a4d13-42af-4429-9fd1-a8218c268e20") },
            { Sub.GRAPHICS_SETTINGS,            new Guid("5FB4938D-1EE8-4b0f-9A3C-5036B0AB995C") },
            { Sub.SW_DYN_GRAPHICS,              new Guid("e276e160-7cb0-43c6-b20b-73f5dce39954") },
            { Sub.POWER_SLIDER,                 new Guid("c763b4ec-0e50-4b6b-9bed-2b92a6ee884e") },
            { Sub.SCHEME_PERSONALITY,           new Guid("245d8541-3943-4422-b025-13a784f679b7") }
        };

        public static Dictionary<Setting, Guid> SubProcGuids = new Dictionary<Setting, Guid>{
        ...
        public static Dictionary<Setting, Guid> SettingGuids = new Dictionary<Setting, Guid>
        {
            ...
            { Setting.PROCTHROTTLEMIN,  new Guid("893dee8e-2bef-41e0-89c6-b55d0929964c") },
            { Setting.PERFBOOSTMODE,    new Guid("be337238-0d82-4146-a960-4f3749d470c7") },
            { Setting.GPU_GLOBAL,       new Guid("a1662ab2-9d34-4e53-ba8b-2639b9e20857") },
            { Setting.GPUPREFERENCE,    new Guid("DD848B2A-8A5D-4451-9AE2-39CD41658F6C") },
            ...
            { Setting.SLIDER_OVERLAY,   new Guid("7ec1751b-60ed-4588-afb5-9819d3d77d90") }
        };
    }
}